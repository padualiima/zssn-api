class SurvivorsController < ApplicationController
  ...
  def create
    ...
    if @survivor.save
      render json: @survivor, status: :created, location: @survivor, include: :inventory
    else
  ...
  private
    ...
    def survivor_params
      params.require(:survivor).permit(:name, :age, :gender, :latitude, :longitude,
        :inventory_attributes => [:survivor_id, :water, :food, :medication, :ammunintion])
    end
    #Allows only latitude and longitude
    def update_params
